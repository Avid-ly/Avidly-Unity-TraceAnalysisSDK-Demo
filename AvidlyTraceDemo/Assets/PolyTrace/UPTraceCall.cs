...
namespace UPTrace
{
    public class UPTraceCall
    {
        ...
        public void initTtraceSDK(string productId, string channelId)
        {
            ...
            int intzone = (int)UPTraceConstant.UPTraceSDKZoneEnum.UPTraceSDKZoneForeign;
        ...
        public void logAASLogin(string loginType, string playerId, string loginToken, string ggid, string extensionJson)
        {
            ...
            {
                Debug.Log("===> fail to call logAASLogin(), loginType can't be null.");
                return;
            }

            if (string.IsNullOrEmpty(playerId))
            {
                Debug.Log("===> fail to call logAASLogin(), playerId can't be null.");
                return;
            }

            if (string.IsNullOrEmpty(ggid))
            {
                Debug.Log("===> fail to call logAASLogin(), ggid can't be null.");
                return;
            }
        ...
        public void logCommonLogin(string loginType, string playerId, string loginToken, string extensionJson)
        {
            if (loginType == null)
            {
                Debug.Log("===> fail to call logCommonLogin(), loginType can't be null.");
                return;
            }
